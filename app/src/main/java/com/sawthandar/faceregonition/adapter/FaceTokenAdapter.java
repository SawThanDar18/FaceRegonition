package com.sawthandar.faceregonition.adapter;
...
import com.sawthandar.faceregonition.R;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.faceTokenNameTv.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                Toast.makeText(v.getContext(), "FaceToken copied", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
